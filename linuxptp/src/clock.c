...
struct port {
	LIST_ENTRY(port) list;	/* duplex link list, replace 'struct port *list ' */
};
...
struct clock {
	...
	LIST_HEAD(ports_head, port) ports;	/* ports_head is name, port is `struct port`; ports is field name */
